...
Manual QA project testing an online ticket purchase flow. 

Includes functional test cases, validation checks, UI/UX observations, and edge case scenarios. Focused on evaluating usability and form validation from an end-user perspective.
